...
function ProjectModal({ project, onClose }) {
    ...
    return createPortal(
        <div
            className="fixed top-0 bg-black/90 mx-auto w-3/4 text-white inset-0 flex items-start justify-start z-50 px-4 pt-30 pb-4"
            onClick={onClose}
        >
           <div className="w-4/4 p-4 grid grid-cols-3 grid-ros-2 gap-4" onClick={(e) => e.stopPropagation()}>
                <div className="glass p-2 p-4 bg-black w-4/4 flex flex-col justify-between row-span-2">
