function ContactForm(){
    return(
        <div className="gradient_bg p-4 glass col-span-5 md:col-span-3 rise-in">
            <form className="flex flex-col gap-2 p-4 md:w-2/3 w-3/3 mx-auto rise-in-children " >
                ...
                <label htmlFor="messege">Enter your message</label>
